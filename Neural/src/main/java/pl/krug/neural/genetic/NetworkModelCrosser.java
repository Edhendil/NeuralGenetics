...
public class NetworkModelCrosser implements GeneticCrosser<NetworkModel> {
    ...
    public void setMutationRate(double mutationRate) {
        _mutator.setMutationRate(mutationRate);
    }
        ...
        for (int i = 0; i < maxSize; i++) {
            if (i < crossoverIndex) {
                forFirstChild = i < parents.get(0).getNeurons().size()
                        && result.get(0).getNeurons().get(i) != null ? parents.get(0).getNeurons().get(i).getLinks() : null;
                forSecondChild = i < parents.get(1).getNeurons().size()
                        && result.get(1).getNeurons().get(i) != null ? parents.get(1).getNeurons().get(i).getLinks() : null;
            } else {
            ...
            if (forFirstChild != null) {
                for (NeuralLinkModel item : forFirstChild) {
                    if (result.get(0).getNeurons().get(item.getDestination().getPosition()) != null) {
                        NeuralLinkModel newLink = new NeuralLinkModel(item);
                        newLink.setDestination(result.get(0).getNeurons().get(item.getDestination().getPosition()));
                        newLink.setSource(result.get(0).getNeurons().get(item.getSource().getPosition()));
            ...
            if (forSecondChild != null) {
                for (NeuralLinkModel item : forSecondChild) {
                    if (result.get(1).getNeurons().get(item.getDestination().getPosition()) != null) {
                        NeuralLinkModel newLink = new NeuralLinkModel(item);
                        newLink.setDestination(result.get(1).getNeurons().get(item.getDestination().getPosition()));
                        newLink.setSource(result.get(1).getNeurons().get(item.getSource().getPosition()));
                        newLink.getSource().addLink(newLink);
                    }
                }
            }
        ...
        for (int i = 0; i < maxSize; i++) {
            if (i < crossoverIndex) {
                ...
                forFirstChild = parents.get(0).getInterfacingNodes().get(i) != null
                        && result.get(0).getNeurons().get(parents.get(0).getInterfacingNodes().get(i).getPosition()) != null ? result.get(0).getNeurons().get(parents.get(0).getInterfacingNodes().get(i).getPosition())
                        : null;
                forSecondChild = parents.get(1).getInterfacingNodes().get(i) != null
                        && result.get(1).getNeurons().get(parents.get(1).getInterfacingNodes().get(i).getPosition()) != null ? result.get(1).getNeurons().get(parents.get(1).getInterfacingNodes().get(i).getPosition())
                        : null;
            } else {
                forFirstChild = parents.get(1).getInterfacingNodes().get(i) != null
                        && result.get(0).getNeurons().get(parents.get(1).getInterfacingNodes().get(i).getPosition()) != null ? result.get(0).getNeurons().get(parents.get(1).getInterfacingNodes().get(i).getPosition())
                        : null;
                forSecondChild = parents.get(0).getInterfacingNodes().get(i) != null
                        && result.get(1).getNeurons().get(parents.get(0).getInterfacingNodes().get(i).getPosition()) != null ? result.get(1).getNeurons().get(parents.get(0).getInterfacingNodes().get(i).getPosition())
                        : null;
            }
    ...
    private void crossoverNeurons(List<NetworkModel> parents,
        ...
        for (int i = 0; i < maxSize; i++) {
            if (i < crossoverIndex) {
                forFirstChild = i < parents.get(0).getNeurons().size() ? parents.get(0).getNeurons().get(i)
                        : null;
                forSecondChild = i < parents.get(1).getNeurons().size() ? parents.get(1).getNeurons().get(i)
                        : null;
            } else {
                forFirstChild = i < parents.get(1).getNeurons().size() ? parents.get(1).getNeurons().get(i)
                        : null;
                forSecondChild = i < parents.get(0).getNeurons().size() ? parents.get(0).getNeurons().get(i)
                        : null;
            }
