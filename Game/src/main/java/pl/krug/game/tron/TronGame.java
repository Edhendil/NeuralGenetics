...
public class TronGame {
    ...
    public void runIteration() {
        ...
        _worldState[(int) _leftPlayerPosition.getY()][(int) _leftPlayerPosition.getX()] = WALL;
        _worldState[(int) _rightPlayerPosition.getY()][(int) _rightPlayerPosition.getX()] = WALL;
        ...
        switch (getMaxPosition(rightResp)) {
            ...
            // go left
            case 1:
                _rightPlayerDirection.setLocation((int) _rightPlayerDirection.getX() != 0 ? 0 : -(int) _rightPlayerDirection.getY(),
    ...
    private void checkGameEnd() {
        ...
        if ((int) _leftPlayerPosition.getY() == (int) _rightPlayerPosition.getY()
                && (int) _leftPlayerPosition.getX() == (int) _rightPlayerPosition.getX()) {
            _gameEnded = true;
            // no winner
        }
        // are they on the wall?
        boolean leftLose = _worldState[(int) _leftPlayerPosition.getY()][(int) _leftPlayerPosition.getX()] == WALL ? true : false;
        boolean rightLose = _worldState[(int) _rightPlayerPosition.getY()][(int) _rightPlayerPosition.getX()] == WALL ? true : false;
